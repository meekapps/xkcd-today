...
- (void) updateZoom {
  ...
  CGFloat widthRatio = self.bounds.size.width / self.comicImageView.bounds.size.width;
  CGFloat heightRatio = self.bounds.size.height / self.comicImageView.bounds.size.height;
  ...
  NSLog(@"setting minimum zoom scale: %@, %@", @(minimumZoomScale), @(maximumZoomScale));
}
